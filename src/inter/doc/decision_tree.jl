...
export report_decision_tree

"""
    report_decision_tree(result::Result) -> String

Generate a Markdown summary of the decision tree/random forest/XGBoost result.
"""
function report_decision_tree(result::Result)
  ...
  md = """
    # Decision Tree / Random Forest / XGBoost Report
...
Generate an HTML report from the decision tree result.
"""
function report_html(result::Result; outpath = nothing)
  md = report_decision_tree(result)
  tmpdir = mktempdir()
...
Generate a PDF report from the decision tree result.
"""
